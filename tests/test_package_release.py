...
from scripts.package_release import ReleasePackagingError, package_release
...
def create_release_tree(tmp_path: Path) -> Path:
    ...
    write_file(root / "example/LICENSE")
    ...
    write_file(root / "linux/gnome-shell/extension.js")
    return root
