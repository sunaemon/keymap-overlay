...
| Platform `*-08` repeated transitions   | `GLOBAL-03` supplies the physical switch proof; macOS and Linux HIL cover deterministic KMO sequences          | Release-renderer transition scenarios remain on GNOME and Windows                                 | Virtual Vial+KMO E2E on GNOME and Windows                                                                 |
